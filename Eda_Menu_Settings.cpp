...
void Eda_Menu_Settings::draw(ALLEGRO_DISPLAY *display, Hanabi_Skin *theme, Hanabi_Board * game_board)
{
	...
	draw_font(display,"Fonts/Alien-Encounters-Solid-Regular.ttf", 0.5, 0.10 , 0.12, "Resolution", al_color_name("black") );
	draw_font(display,"Fonts/OpenSans-Regular.ttf", 0.5, 0.23 , 0.1, available_resolutions[selected_resolution], al_color_name("black") );
	draw_font(display,"Fonts/OpenSans-Regular.ttf", 0.5, 0.23 , 0.1, available_resolutions[selected_resolution], al_color_name("black") );
	
	draw_font(display,"Fonts/Alien-Encounters-Solid-Regular.ttf", 0.5, 0.415 , 0.12, "Theme", al_color_name("black") );
	draw_font(display,"Fonts/OpenSans-Regular.ttf", 0.5, 0.53 , 0.1, available_themes[selected_theme], al_color_name("black") );
	
	draw_font(display,"Fonts/Alien-Encounters-Solid-Regular.ttf", 0.5, 0.7 , 0.12, "Memory Help", al_color_name("black") );
	draw_font(display,"Fonts/Alien-Encounters-Solid-Regular.ttf", 0.5, 0.85 , 0.12, "Full Screen", al_color_name("black") );
